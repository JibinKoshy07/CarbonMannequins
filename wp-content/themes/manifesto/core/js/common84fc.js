...
---------------------------------------------------*/
	...
	window.ScrollEffects = function() {
		...
		if ($('body').hasClass("swap-logo")) {
			...
			var originalSrcWhite = 'images/logo-white.html';
			var updatedSrcWhite = 'images/logo-white-symbol.png';
			
			var imgLogoBlack = document.querySelector('.black-logo');
			var originalSrcBlack = 'images/logo.html';
			var updatedSrcBlack = 'images/logo-symbol.html';
...
---------------------------------------------------*/
	...
	window.Lightbox = function() {
		...
		function showVideoDetails(event, item) {
			...
			if( videoUrl.indexOf('vimeo.com/index.html') >= 0 ){
			...
			else if( videoUrl.indexOf('youtube.com/index.html') >= 0 ){
